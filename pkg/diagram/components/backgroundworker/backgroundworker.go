...
//go:embed backgroundworker.html
var templateFile embed.FS

var tmpl = template.Must(template.New("background-worker").Funcs(template.FuncMap{
	"add": func(a, b float64) float64 { return a + b },
	"mul": func(a, b float64) float64 { return a * b },
	"sub": func(a, b float64) float64 { return a - b },
}).ParseFS(templateFile, "backgroundworker.html"))
...
func (l *Legacy) Draw() string {
	...
	if err := tmpl.ExecuteTemplate(&buf, "background-worker", l.data()); err != nil {
