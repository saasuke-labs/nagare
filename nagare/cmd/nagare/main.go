...
@nginx(x:50,y:50,w:75,h:50)
@app(x:175,y:50,w:75,h:50)

@home(url: "https://www.nagare.com", bg: "#e6f3ff", fg: "#333", text: "Home Page")
@ubuntu(title: "home@ubuntu", bg: "darkorange", fg: "#333", text: "Ubuntu")
@nginx(title: "Nginx", icon: "nginx", port: 80, bg: "#e6f3ff", fg: "#333")
@app(title: "App", icon: "golang", port: 8080, bg: "#f0f8ff", fg: "#333")
`
